...
import {updateHotelImage} from "@/actions/hotelActions";
...
interface AddHotelImageProps {
  hotel: IHotel;
}

const AddHotelImage = ({hotel}: AddHotelImageProps) => {
  ...
  return (
    <div className="my-20 flex w-full items-center justify-center">
      <div className="min-w-[80%] space-y-4 rounded-lg p-5 shadow-lg shadow-black dark:shadow-white">
        ...
        >
          <h1 className="mb-5 text-2xl font-bold">Add Hotel Image</h1>
          <div
