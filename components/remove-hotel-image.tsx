...
import {deleteHotelImage} from "@/actions/hotelActions";
import {IHotel} from "@/models/hotelModel";

import {Card, CardContent} from "./ui/card";

interface RemoveHotelImageProps {
  hotel: IHotel;
}

const RemoveHotelImage = ({hotel}: RemoveHotelImageProps) => {
  const [files, setFiles] = useState(hotel.image);
  ...
  const handleDelete = async (publicId: string) => {
    ...
    try {
      ...
      toast.success("Hotel image removed!");
    } catch (error: any) {
